...
func Main(c *config.C, configTest bool, buildVersion string, logger *logrus.Logger, tunFd *int) (retcon *Control, reterr error) {
	...
	if !configTest {
		...
		//TODO: move routes and unsafe routes into overlay entirely like https://github.com/nbrownus/nebula/tree/system-routing
		tun, err = overlay.NewTunFromConfig(c, l, tunCidr, tunFd, routines)
		if err != nil {
